...
var feed = 'http://kansan.com/api/get_category_posts/?slug=entertainment';
var section = 'News';
...
/**********ACTUAL API LOADING*************/
	...
	xhr.onload = function() {	
		...
		tableview.addEventListener('click',function(e) {
			...
			var articleContent = "<body style='"+font1+"; width:94%; mgin:0 auto;font-size:15px;'><h3 style='fontar-size:25px;text-transform:uppercase;color:#358CCB;margin-top:10px;line-height:14px"+font2+"'>"+e.row.headline+"</h3><div style='font-size:16px;color:#999999;margin-top:-18px;'>By "+e.row.author;
